...
# Lógica de atualização (JOB QUEUE)
def atualizar_planilhas(context):
    ...
    for aba_code, aba_config in LIGAS_MAP.items():
        ...
        # ✅ NOVO LOG DE DEBBUGING: QUANTIDADE DE JOGOS
        ...
        logging.info(f"✅ DEBUG: API retornou {len(jogos_future)} jogos FUTURE para a liga {aba_code}.") # Adicionado Log
