# ===============================================================================
# 🏆 BOT DE ESTATÍSTICAS DE CONFRONTO V2.2.8 - CÓDIGO FINAL E COMPLETO (FINAL GSHEETS FIX)
# ===============================================================================
...
if not CREDS_JSON_STRING:
    ...
    try:
        ...
        # ESTA É A CORREÇÃO FINAL PARA O PROBLEMA DE VARIÁVEL LONGA NO RENDER
...
async def exibir_confronto(update: Update, context: ContextTypes.DEFAULT_TYPE, filtro_tipo: str, ultimos: str, cond_m: str, cond_v: str):
    ...
    # O limite de caracteres do Telegram é 4096.
...
def main():
    ...
    if client:
        ...
        # CORREÇÃO: Agenda a pré-carga de cache para rodar na primeira oportunidade (evita 'no running event loop')
...
if __name__ == '__main__':
    ...
    # O JobQueue e a App rodam no loop de eventos que é gerenciado pelo Werkzeug/Flask.
    try:
