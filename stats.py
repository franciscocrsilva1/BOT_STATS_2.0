# ===============================================================================
# 🏆 BOT DE ESTATÍSTICAS DE CONFRONTO V2.2.6 - CORREÇÃO DE CALLBACK DATA (64 BYTES)
# ===============================================================================
    ...
    if status == "FUTURE":
        ...
        for jogo in jogos_a_listar:
            try:
                ...
                # ✅ CORREÇÃO: Mesmo se o nome for longo, o JOGO|ABA|M|V ainda pode estourar.
                # Vamos encurtar o nome APENAS para o callback, se necessário, para garantir a funcionalidade
                callback_data = f"JOGO|{aba_code}|{M_safe}|{V_safe}"
                
                if len(callback_data.encode('utf-8')) > 64:
                    # Se estourar, usa as primeiras 8 letras de cada nome
...
async def mostrar_menu_acoes(update: Update, context: ContextTypes.DEFAULT_TYPE, aba_code: str, mandante: str, visitante: str):
    ...
    # Usei 'C0' como chave fixa por simplicidade. O ideal é usar chat_id ou user_id.
    ...
    for label, tipo, ultimos, cond_m, cond_v in CONFRONTO_FILTROS:
        ...
        # O callback agora tem APENAS o ID do confronto
...
async def processar_confronto(
    ...
    """Calcula e exibe as estatísticas para os dois times, recuperando os nomes do context.user_data."""
    ...
    keyboard = [
        # O botão de voltar deve usar o nome COMPLETO, que é a chave de retorno para o menu JOGO
