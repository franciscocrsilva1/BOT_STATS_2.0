# ===============================================================================
# 🏆 BOT DE ESTATÍSTICAS DE CONFRONTO V2.2.8 - NOVOS FILTROS DE OVER/SOFRER E AMBOS OS TEMPOS
# ===============================================================================
...
# =================================================================================
# 📈 FUNÇÕES DE CÁLCULO E FORMATAÇÃO DE ESTATÍSTICAS (COM NOVOS FILTROS)
# =================================================================================
def calcular_estatisticas_time(time, aba, ultimos=None, casa_fora=None):
    ...
    d = {"time":time,"jogos_time":0,"jogos_casa":0,"jogos_fora":0,
         ...
         # NOVAS CHAVES DE CONTAGEM
         "m_over15_s_over15": 0, "m_over15_s_over15_casa": 0, "m_over15_s_over15_fora": 0, # Marcou 2+ E Sofreu 2+
         "m_ambos_t": 0, "m_ambos_t_casa": 0, "m_ambos_t_fora": 0} # Marcou em Ambos os Tempos
    ...
    for linha in linhas:
        ...
        if em_casa:
            ...
            marcados_1t, sofridos_1t = gm1, gv1
            marcados_2t, sofridos_2t = gm2, gv2
            d["jogos_casa"] += 1
            ...
            marcados_1t, sofridos_1t = gv1, gm1
            marcados_2t, sofridos_2t = gv2, gm2
            d["jogos_fora"] += 1
        ...
        # GAT (Gol em Ambos os Tempos - Total Jogo)
        gol_no_1t = total1 > 0
        ...
        d["gols_marcados_1T"] += marcados_1t
        d["gols_sofridos_1T"] += sofridos_1t
        d["gols_marcados_2T"] += marcados_2t
        d["gols_sofridos_2T"] += sofridos_2t
        
        # 📌 NOVA LÓGICA 1: MANDANTE/VISITANTE MARCOU > 1.5 E SOFREU > 1.5 (Marcou 2+ e Sofreu 2+)
        if marcados >= 2 and sofridos >= 2: # Equivalente a Over 1.5 Gols Marcados e Over 1.5 Gols Sofridos
            d["m_over15_s_over15"] += 1
            d["m_over15_s_over15_casa" if em_casa else "m_over15_s_over15_fora"] += 1

        # 📌 NOVA LÓGICA 2: MANDANTE/VISITANTE MARCOU EM AMBOS OS TEMPOS
        if marcados_1t > 0 and marcados_2t > 0:
            d["m_ambos_t"] += 1
            d["m_ambos_t_casa" if em_casa else "m_ambos_t_fora"] += 1
...
def formatar_estatisticas(d):
    ...
    """Formata o dicionário de estatísticas para a mensagem do Telegram (COM NOVOS FILTROS)."""
    ...
    return (f"📊 **Estatísticas - {escape_markdown(d['time'])}**\n"
            ...
            f"🎯 **Marcou 2+ e Sofreu 2+:** **{pct(d['m_over15_s_over15'], jt)}** (C: {pct(d.get('m_over15_s_over15_casa',0), jc)} | F: {pct(d.get('m_over15_s_over15_fora',0), jf)})\n"
            f"💥 **Marcou em Ambos os Tempos:** **{pct(d['m_ambos_t'], jt)}** (C: {pct(d.get('m_ambos_t_casa',0), jc)} | F: {pct(d.get('m_ambos_t_fora',0), jf)})\n\n"
...
async def processar_confronto(
    ...
    filtro_mandante = "casa" if mandante_filtro == "casa" else None
    filtro_visitante = "fora" if visitante_filtro == "fora" else None
