# ===============================================================================
# 🏆 BOT DE ESTATÍSTICAS DE CONFRONTO V2.2.6 - CÓDIGO FINAL E COMPLETO
# ===============================================================================
...
# =================================================================================
# 📈 FUNÇÕES DE CÁLCULO E FORMATAÇÃO DE ESTATÍSTICAS (SEM ALTERAÇÕES)
# =================================================================================
...
# =================================================================================
# 🤖 FUNÇÕES DO BOT: HANDLERS E FLUXOS (SEM ALTERAÇÕES)
# =================================================================================
...
# =================================================================================
# 🚀 FUNÇÃO PRINCIPAL (WEBHOOK E FLASK - CÓDIGO FINAL DE PRODUÇÃO)
# =================================================================================
...
# Variáveis globais para o Webhook
app = None
bot_instance = None 
...
def main():
    ...
    if client:
        ...
        # Pré-carregamento 1x no início
        job_queue.run_once(pre_carregar_cache_sheets, when=0, name="PreCarregarCache") 
        # Atualização periódica (roda 1h depois e repete a cada 1h)
    ...
    # ===== Configuração do Webhook (CORREÇÃO FINAL ISOLADA) =====
    ...
    try:
        # PASSO 1: Configura o Webhook de forma totalmente SINCRONA (via requests)
        # Isso EVITA o conflito de loop assíncrono que causava o TypeError.
        ...
        logging.info(f"✅ Webhook configurado com sucesso (via Requests) para: {webhook_url}")

        # PASSO 2: Inicializa e Inicia o Application em uma TAREFA SEPARADA
        # Isso é fundamental para que o JobQueue e o Application rodem em background.
        async def start_application_background():
            await app.initialize()
            await app.start()

        # Cria a tarefa, mas não a espera (continua o fluxo Flask)
        asyncio.create_task(start_application_background())
        logging.info("✅ Application iniciado em background (para JobQueue e contexto assíncrono).")
        
    except Exception as e:
        logging.error(f"❌ Erro CRÍTICO ao configurar o webhook e inicializar o App: {e}")
        sys.exit(1)
