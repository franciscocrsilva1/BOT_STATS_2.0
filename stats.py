...
# =================================================================================
# 🚦 CONTROLADOR DE FLUXO GERAL - FUNÇÃO CORRIGIDA
# =================================================================================
async def callback_query_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Isso resolve o erro 'bound to a different event loop' que ocorre quando 
    # o CallbackQueryHandler roda em um thread de worker diferente do loop principal.
    nest_asyncio.apply()
    # =================================================================
    
    try:
        query = update.callback_query
        # Esta é a linha que estava falhando antes do fix.
