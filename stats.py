# ===============================================================================
# 🏆 BOT DE ESTATÍSTICAS DE CONFRONTO V2.2.5 - CÓDIGO FINAL E COMPLETO
# ===============================================================================
...
# =================================================================================
# 🚀 FUNÇÃO PRINCIPAL (CORREÇÃO CONCORRÊNCIA ASYNC/SYNC)
# =================================================================================
...
def main():
    ...
    # ===== Configuração do Webhook (CORREÇÃO FINAL AQUI!) =====
    ...
    # 2. Configura o Webhook e Inicia o Application (Concorrentemente)
    try:
        # PASSO 1: Configura o Webhook de forma síncrona/bloqueante no loop principal.
        async def set_webhook_only():
            await bot_instance.set_webhook( 
                url=webhook_url,
                allowed_updates=Update.ALL_TYPES
            )
        
        # Executa a configuração (este é o ponto que estava falhando antes)
        asyncio.run(set_webhook_only())
        ...
        # Isso permite que o JobQueue rode concorrentemente com o servidor Flask.
        async def start_application_background():
            await app.initialize()
            await app.start()

        # Cria a tarefa, mas não a espera
        ...
        logging.error(f"❌ Erro ao configurar o webhook e inicializar o App: {e}")
        sys.exit(1)
